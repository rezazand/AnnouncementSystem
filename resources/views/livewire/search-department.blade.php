                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input onclick="processChange();modalName='showDepartmentEdit';" wire:model="check"
                                   value="{{$department->id}}" id="editDep-{{$department->id}}" type="radio" style="display: none;">
                ...
                <div class="modal-body">
                    <form action="{{route('edit-department')}}" method="POST">
                        ...
                        <div class="input-group mb-4">
                            <input id="name" type="text" class="form-control" placeholder="نام زیرمجموعه" name="label" @if($check)value="{{\App\Models\Department::find($check)->label}}"@endif>
